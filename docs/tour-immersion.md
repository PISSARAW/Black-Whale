...
| Espaces avec une fenêtre               | **2 sur 387**                                           |
...
Le chiffre le plus fort du blueprint : **387 espaces, 2 fenêtres.**
...
Effet : sur 387 pièces, il y a deux endroits où l'extérieur existe, et on les sent en
...
5. **2 fenêtres sur 387 espaces** — le huis clos est déjà dans la donnée, il n'est
