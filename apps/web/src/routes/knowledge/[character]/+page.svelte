...
<div class="max-w-5xl mx-auto p-6 space-y-5">
  <header class="bw-panel p-5">
    ...
    <p class="text-sm text-slate-300 mt-2">An archive of knowledge, suspicions, rumors, and outdated information.</p>
  </header>
  ...
  <section class="bw-panel p-4">
    <h2 class="text-sm uppercase tracking-widest text-slate-400 mb-3">Knowledge graph (optional)</h2>
    <pre class="text-xs bg-slate-950/70 border border-slate-700 rounded p-3 overflow-x-auto">[Fugetsu] --believes--> [Kacho]
