...
<div class="max-w-6xl mx-auto p-6 space-y-5">
  <header class="bw-panel p-5">
    ...
    <p class="text-sm text-slate-300 mt-2">Subjective map and timeline: what this character knows, believes, suspects, or ignores.</p>
  </header>
  ...
  <section class="grid lg:grid-cols-[1.2fr_1fr] gap-4">
    <article class="bw-panel p-4 min-h-[18rem]">
      ...
      <p class="text-sm text-slate-200">The same SVG geometry, with knowledge layers adapted to the selected perspective.</p>
