...
<svg viewBox="0 0 1000 800" class="w-full h-full text-[#FFFFF0] bg-[#050505] rounded-lg border border-[#333]">
  <defs>
    <style>
      .wall { stroke: #FFFFF0; stroke-width: 6; fill: none; }
      .stage { fill: rgba(139, 69, 19, 0.2); stroke: #8b4513; stroke-width: 3; }
      .table { fill: rgba(255, 255, 255, 0.1); stroke: #666; stroke-width: 2; cursor: pointer; transition: fill 0.2s; }
      .table:hover { fill: rgba(255, 215, 0, 0.3); stroke: #FFD700; }
      .throne-platform { fill: rgba(255, 215, 0, 0.1); stroke: #FFD700; stroke-width: 3; }
      .buffet { fill: rgba(200, 200, 200, 0.15); stroke: #aaa; stroke-width: 2; }
      .door { stroke: #FFD700; stroke-width: 6; cursor: pointer; }
  ...
  <g transform="translate(50, 80)">
    ...
    <line class="wall" x1="100" y1="120" x2="800" y2="120" /> <!-- Stage edge -->
