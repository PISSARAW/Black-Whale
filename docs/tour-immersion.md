...
| Espaces avec une fenêtre               | **2 sur 386**                                           |
...
Le chiffre le plus fort du blueprint : **386 espaces, 2 fenêtres.**
...
Effet : sur 386 pièces, il y a deux endroits où l'extérieur existe, et on les sent en
...
5. **2 fenêtres sur 386 espaces** — le huis clos est déjà dans la donnée, il n'est
