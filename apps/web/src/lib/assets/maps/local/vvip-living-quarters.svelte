<script lang="ts">
  function handleElementClick(elementId: string) {
    console.log(`Clicked on ${elementId} in VVIP Living Quarters`);
  }
</script>
...
<svg viewBox="0 0 1000 600" class="w-full h-full text-[#FFFFF0] bg-[#050505] rounded-lg border border-[#333]">
  <defs>
    <style>
      ...
      .corridor { fill: rgba(255, 255, 255, 0.02); }
    </style>
  </defs>

  <text x="500" y="40" class="label" font-size="28" fill="#FFD700">VVIP Living Quarters (Tier 1)</text>
  <text x="500" y="65" class="sublabel text-gray-500">Residence for V5 Politicians, Dignitaries, Mafia Bosses & Confined Princes</text>
  ...
  <g transform="translate(50, 100)">
    ...
    <text x="450" y="35" class="sublabel text-gray-400">Main Corridor (To Banquet Hall / Soldier Quarters)</text>
