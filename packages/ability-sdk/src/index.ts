...
export const attach = (): AbilityInteraction => ({
  id: 'attach',
  label: 'Attach',
  targetTypes: [],
  conditions: [],
})
export const stretch = (): AbilityInteraction => ({
  id: 'stretch',
  label: 'Stretch',
  targetTypes: [],
  conditions: [],
})
export const retract = (): AbilityInteraction => ({
  id: 'retract',
  label: 'Retract',
  targetTypes: [],
  conditions: [],
})
export const detach = (): AbilityInteraction => ({
  id: 'detach',
  label: 'Detach',
  targetTypes: [],
  conditions: [],
})
export const release = (): AbilityInteraction => ({
  id: 'release',
  label: 'Release',
  targetTypes: [],
  conditions: [],
...
export const elasticConnection = (): EffectBuilder => (ctx) =>
  effectEvent(ctx, 'ELASTIC_BINDING', { retractable: true, adhesive: true })
export const adhesiveConnection = (): EffectBuilder => (ctx) =>
  effectEvent(ctx, 'ADHESIVE_BINDING', { adhesive: true })
export const transferConsciousness = (): EffectBuilder => (ctx) => {
  ...
  const fromBodyId =
    typeof ctx.parameters?.fromBodyId === 'string' ? ctx.parameters.fromBodyId : undefined
...
export const teleport = (): EffectBuilder => (ctx) => {
  ...
  const locationId =
    typeof ctx.parameters?.locationId === 'string' ? ctx.parameters.locationId : undefined
...
export const detectAura = (): EffectBuilder => (ctx) =>
  effectEvent(ctx, 'AURA_MODIFIER', { mode: 'DETECTION' })
