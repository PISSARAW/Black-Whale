export type BiologicalState =
  'ALIVE' | 'INJURED' | 'UNCONSCIOUS' | 'DEAD' | 'DESTROYED' | 'PRESERVED' | 'UNKNOWN'
...
export type NenCategory =
  'enhancer' | 'emitter' | 'transmuter' | 'conjurer' | 'manipulator' | 'specialist' | 'unknown'
...
export type OccupancyType =
  'ORIGINAL' | 'TRANSFERRED' | 'POSSESSED' | 'CONTROLLED' | 'EMPTY' | 'UNKNOWN'
