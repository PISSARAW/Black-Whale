...
const present = { id: 'present', chapterId: 'ch-400', chapter: { number: 400 }, sequence: 1, ordinal: 20 }
const flashback = { id: 'flashback', chapterId: 'ch-410', chapter: { number: 410 }, sequence: 1, ordinal: 10 }
