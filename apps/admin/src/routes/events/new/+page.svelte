...
<div class="p-8 max-w-3xl mx-auto">
	...
	<form method="POST" class="space-y-8">
		...
		<div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 space-y-4">
			...
			<div class="grid grid-cols-2 gap-4">
				<div>
					...
					<select name="chapterId" class="w-full border-gray-300 rounded-md shadow-sm p-2 border" required>
				...
				<div>
					...
					<input type="number" name="sequence" class="w-full border-gray-300 rounded-md shadow-sm p-2 border" required min="1" placeholder="e.g. 4">
				</div>
			</div>
		...
		<div class="bg-gray-50 p-6 rounded-lg border border-gray-200 space-y-4">
			...
			<p class="text-sm text-gray-500 mb-4">Adding a movement will automatically close the character's previous presence.</p>
