...
<svg viewBox="0 0 1000 600" class="w-full h-full text-[#FFFFF0] bg-[#050505] rounded-lg border border-[#333]">
  <defs>
    <style>
      ...
      .barracks { fill: #1a1a2e; stroke: #2a2a4e; stroke-width: 2; }
      .bunk { fill: #111; stroke: #444; }
      .hunter { fill: #2e8b57; stroke: #006400; stroke-width: 1; }
      .soldier { fill: #4a5568; stroke: #2d3748; stroke-width: 1; }
    </style>
  </defs>
