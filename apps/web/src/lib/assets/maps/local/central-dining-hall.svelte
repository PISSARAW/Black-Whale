...
>
  ...
  <text x="500" y="40" class="label" font-size="28" fill="#FFD700"
    >Central Dining Hall (Tier 5)</text
  >
  ...
  <g transform="translate(50, 80)">
    ...
    <rect
      ...
      width="500"
      height="200"
      onclick={() => handleElementClick('main-table')}
    />

    <rect x="350" y="280" width="300" height="80" class="table" />
    <rect x="330" y="250" width="340" height="20" class="bench" />
    <!-- Top bench -->
    <rect x="330" y="370" width="340" height="20" class="bench" />
    <!-- Bottom bench -->
