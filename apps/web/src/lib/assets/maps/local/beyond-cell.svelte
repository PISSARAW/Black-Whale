...
<svg viewBox="0 0 800 600" class="w-full h-full text-[#FFFFF0] bg-[#050505] rounded-lg border border-[#333]">
  <defs>
    <style>
      .wall { stroke: #FFFFF0; stroke-width: 8; fill: none; }
      .bars { stroke: #999; stroke-width: 4; fill: none; stroke-dasharray: 5,15; }
      .zone { fill: rgba(255, 215, 0, 0.05); transition: fill 0.2s; cursor: pointer; }
      .zone:hover { fill: rgba(255, 215, 0, 0.15); }
      .label { fill: #FFFFF0; font-family: sans-serif; font-size: 18px; font-weight: bold; pointer-events: none; text-anchor: middle; }
      .sublabel { fill: #FFD700; font-size: 14px; pointer-events: none; text-anchor: middle; }
      .manacle { stroke: #FFD700; stroke-width: 3; fill: none; }
    </style>
  </defs>
  ...
  <g transform="translate(100, 100)">
    ...
    <circle cx="110" cy="160" r="10" stroke="#FFD700" stroke-width="2" fill="none" /> <!-- Cuff -->
    <rect x="0" y="150" width="10" height="20" fill="#FFD700" /> <!-- Wall Bolt -->

    <!-- Urinal -->
    <path d="M 30 30 Q 50 30 50 50 L 50 70 Q 50 90 30 90 L 0 90 L 0 30 Z" fill="#222" stroke="#444" stroke-width="2" />
    <text x="25" y="65" class="sublabel text-[9px] text-gray-400">Urinal</text>

    <!-- Cell Bars (Center division) -->
    ...
    <polygon points="535,60 510,80 520,90 545,70" fill="#FFD700" opacity="0.3" />

    <!-- Entrance to Guard Area -->
    <line x1="600" y1="150" x2="600" y2="250" stroke="#050505" stroke-width="12" /> <!-- Doorway -->
    <line x1="600" y1="150" x2="650" y2="120" stroke="#FFD700" stroke-width="4" />
    <text x="650" y="200" class="label" font-size="12">To Corridors</text>
  </g>
</svg>
