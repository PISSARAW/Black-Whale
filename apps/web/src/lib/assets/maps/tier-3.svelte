<script lang="ts">
  ...
  const regions: Region[] = [
    ...
    },
    {
      ...
      region: 't3-obs-deck',
      points: '100.0,100.0 100.0,470.0 77.14,448.57 60.0,385.71 51.43,300.0 60.0,214.29 77.14,151.43',
    ...
    },
    {
      ...
      region: null,
      points: '400.0,171.43 600.0,171.43 600.0,280.0 400.0,280.0',
      label: 'Royal Army Local Section',
      size: 12,
      at: [500.0, 229.7],
      turned: false,
      through: false,
    ...
    },
    {
      ...
      region: null,
      points: '400.0,100.0 600.0,100.0 600.0,171.43 400.0,171.43',
...
<svg viewBox="0 0 1000 600" class="w-full h-full text-[#FFFFF0]">
  ...
  <polygon class="hull" points="120.0,50.0 90.31,64.0 67.2,102.0 50.71,158.0 40.8,226.0 37.51,300.0 40.8,374.0 50.71,442.0 67.2,498.0 90.31,536.0 120.0,550.0 850.0,550.0 885.11,536.0 912.4,498.0 931.89,442.0 943.6,374.0 947.51,300.0 943.6,226.0 931.91,158.0 912.4,102.0 885.11,64.0 850.0,50.0" />
