          ...
          {#if character.abilities?.length}
            <div class="ability-grid">
              {#each character.abilities as ability}
                ...
                <article class:interactive={Boolean(profile)} class:active={$activeHatsu?.id === ability.id} style:--ability-color={profile?.color || 'var(--accent-cyan)'}>
                  <small>{ability.category}{ability.secondaryCategories?.length ? ` · ${ability.secondaryCategories.join(' · ')}` : ''}</small>
                  <h3>{ability.name}</h3>
                  {#if ability.alternateNames?.length}<span>{ability.alternateNames.join(' / ')}</span>{/if}
                  {#if profile}
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <small>{$activeHatsu?.id === ability.id ? 'HATSU ACTIVE' : 'CLICK DESCRIPTION TO ACTIVATE'}</small>
                    </button>
                  {:else}
...
<style>
  ...
  .prose-record{max-width:52rem;margin-top:1.5rem}.prose-record p,.capability-summary p,.nen-profile p,.ability-grid p,.equipment-grid p,.encounter-grid p{color:var(--text-secondary);font-size:.72rem;line-height:1.72}.capability-summary{margin-top:1.8rem;padding:1.2rem;border-left:2px solid var(--accent-cyan);background:rgba(112,189,193,.05)}.capability-summary small,.nen-profile small,.ability-grid small,.encounter-grid small{color:var(--accent-cyan);font:.48rem/1 var(--font-mono);letter-spacing:.08em}.capability-summary p{margin:.6rem 0 0}.equipment-grid,.ability-grid,.encounter-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.75rem;margin-top:1.2rem}.equipment-grid article,.ability-grid article,.encounter-grid article{padding:1rem;border:1px solid var(--line-subtle);background:rgba(12,20,25,.45)}.ability-grid article.interactive{border-color:color-mix(in srgb,var(--ability-color) 30%,var(--line-subtle));transition:border-color .2s,box-shadow .2s}.ability-grid article.interactive:hover,.ability-grid article.active{border-color:var(--ability-color);box-shadow:inset 0 0 24px color-mix(in srgb,var(--ability-color) 6%,transparent)}.equipment-grid p,.ability-grid p,.encounter-grid p{margin:.55rem 0 0}.nen-profile{display:grid;grid-template-columns:minmax(11rem,.3fr) 1fr;gap:1.5rem;margin-top:1.5rem}.nen-profile>article{display:grid;align-content:start;gap:.55rem;padding:1.2rem;border:1px solid var(--line-default)}.nen-profile strong{color:var(--accent-gold);font:500 1.4rem/1 var(--font-display);text-transform:uppercase}.nen-profile span,.ability-grid span{color:var(--text-faint);font-size:.58rem}.nen-profile p{margin:0 0 .8rem}.technique-list{display:flex;flex-wrap:wrap;gap:.4rem;margin-top:1rem}.technique-list span{padding:.38rem .55rem;border:1px solid var(--line-default);border-radius:999px;color:var(--text-secondary);font:.5rem/1 var(--font-mono)}.ability-grid h3{margin:.45rem 0;font-size:1.2rem}.ability-description{display:grid;width:100%;gap:.6rem;margin-top:.55rem;padding:.75rem;border:1px solid transparent;border-radius:.3rem;background:color-mix(in srgb,var(--ability-color) 5%,transparent);color:var(--text-secondary);text-align:left;cursor:pointer;transition:background .2s,border-color .2s}.ability-description:hover,.ability-description:focus-visible{border-color:color-mix(in srgb,var(--ability-color) 55%,transparent);background:color-mix(in srgb,var(--ability-color) 10%,transparent);outline:none}.ability-description>span{color:var(--text-secondary);font-size:.72rem;line-height:1.72}.ability-description>small{color:var(--ability-color);font:.46rem/1 var(--font-mono);letter-spacing:.1em}.appearance-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1px;margin-top:1.5rem;background:var(--line-subtle);border:1px solid var(--line-subtle)}.appearance-grid article{display:grid;grid-template-columns:3rem 1fr;gap:.7rem;padding:.75rem;background:var(--surface-deep)}.appearance-grid strong{color:var(--accent-gold);font:500 1rem/1 var(--font-display)}.appearance-grid div{display:grid;gap:.3rem}.appearance-grid span{font-size:.62rem}.appearance-grid small{color:var(--text-faint);font:.45rem/1 var(--font-mono);text-transform:uppercase}
