const messages = {
  en: {
    ...
    entered: 'entered',
    summary: {
      title: 'What shaped the outcome', metrics: 'Reading', rooms: 'Rooms', zetsu: 'Zetsu',
      hatsu: 'Hatsu', falseTrails: 'False trails',
      insight: {
  ...
  fr: {
    ...
    entered: 'entre dans',
    summary: {
      title: "Ce qui a façonné l'issue", metrics: 'Lecture', rooms: 'Pièces', zetsu: 'Zetsu',
      hatsu: 'Hatsu', falseTrails: 'Fausses pistes',
      insight: {
