...
<svg viewBox="0 0 800 600" class="w-full h-full text-[#FFFFF0]">
  ...
  <rect class="zone" x="50" y="250" width="100" height="100" on:click={() => handleElementClick('entrance')} />
  ...
  <rect class="zone" x="150" y="50" width="200" height="200" on:click={() => handleElementClick('dining')} />
  <text x="250" y="150" class="label">Cuisine & Salle à manger</text>
  
  <!-- Quartiers serviteurs (Bottom left) -->
  <rect class="zone" x="150" y="350" width="200" height="200" on:click={() => handleElementClick('servants')} />
  <text x="250" y="450" class="label">Quartiers Serviteurs</text>
  
  <!-- Toilettes Communes (near corridor/servants) -->
  <rect class="zone" x="300" y="250" width="50" height="100" on:click={() => handleElementClick('shared-toilets')} />
  <text x="325" y="305" class="label text-[10px]" transform="rotate(-90 325 305)">Toilettes</text>
  
  <!-- Grand séjour (Center) -->
  <rect class="zone" x="350" y="50" width="250" height="500" on:click={() => handleElementClick('living')} />
  ...
  <rect class="zone" x="600" y="50" width="150" height="300" on:click={() => handleElementClick('master-bedroom')} />
  ...
  <rect class="zone" x="600" y="350" width="150" height="100" on:click={() => handleElementClick('master-shower')} />
  <text x="675" y="405" class="label text-xs">Douche</text>
  
  <rect class="zone" x="600" y="450" width="150" height="100" on:click={() => handleElementClick('master-toilet')} />
