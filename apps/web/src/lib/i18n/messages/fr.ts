...
export const fr: Messages = {
  ...
  tourSources: {
    ...
    seoDescription:
      'Les preuves derrière le Black Whale reconstruit, pièce par pièce : le chapitre ou le plan sur lequel repose chacun des 266 espaces, les couloirs que la reconstruction a inventés, et les cloisons murées à dessein.',
    breadcrumb: 'Sources',
