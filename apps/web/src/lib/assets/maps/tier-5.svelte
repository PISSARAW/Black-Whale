...
<svg viewBox="0 0 1000 600" class="w-full h-full text-[#FFFFF0]">
  ...
  <g id="tier-5-zones">
    ...
    <g id="t5-recycling" role="button" tabindex="0" aria-label="Open Recycling Boundary" onclick={() => handleZoneClick('t5-recycling')} onkeydown={(event) => handleZoneKeydown(event, 't5-recycling')}>
    ...
    <g role="button" tabindex="0" aria-label="Open Residential Zone" onclick={() => handleZoneClick('t5-residential')} onkeydown={(event) => handleZoneKeydown(event, 't5-residential')}>
      ...
      <g role="button" tabindex="0" aria-label="Open Room 37564" onclick={(e) => { e.stopPropagation(); handleZoneClick('room-37564'); }} onkeydown={(event) => handleZoneKeydown(event, 'room-37564')}>
    ...
    <!-- Entrepôts & Stockage -->
    <g id="t5-warehouses" role="button" tabindex="0" aria-label="Open Warehouses" onclick={() => handleZoneClick('t5-warehouses')} onkeydown={(event) => handleZoneKeydown(event, 't5-warehouses')}>
    ...
    <!-- Bureau Cha-R -->
    <g id="t5-char" role="button" tabindex="0" aria-label="Open Cha-R Territory" onclick={() => handleZoneClick('t5-char')} onkeydown={(event) => handleZoneKeydown(event, 't5-char')}>
    ...
    <!-- Cafétéria -->
    <g id="t5-cafeteria" role="button" tabindex="0" aria-label="Open Central Dining Hall" onclick={() => handleZoneClick('central-dining-hall')} onkeydown={(event) => handleZoneKeydown(event, 'central-dining-hall')}>
    ...
    <g id="t5-medical-none" role="button" tabindex="0" aria-label="Open Limited Medical Service" onclick={() => handleZoneClick('t5-medical-none')} onkeydown={(event) => handleZoneKeydown(event, 't5-medical-none')}>
