...
<svg viewBox="0 0 1000 600" class="w-full h-full text-[#FFFFF0]">
  ...
  <g id="tier-1-zones">
    ...
    <g id="t1-king-quarters" role="button" tabindex="0" aria-label="Open King's Living Quarters" onclick={() => handleZoneClick('king-quarters')} onkeydown={(event) => handleZoneKeydown(event, 'king-quarters')}>
    ...
    <g id="t1-burial-chamber" role="button" tabindex="0" aria-label="Open Princes' Burial Chamber" onclick={() => handleZoneClick('princes-burial-chamber')} onkeydown={(event) => handleZoneKeydown(event, 'princes-burial-chamber')}>
    ...
    <!-- Banquet Hall (Middle) -->
    <g id="t1-banquet-hall" role="button" tabindex="0" aria-label="Open Banquet Hall" onclick={() => handleZoneClick('banquet-hall')} onkeydown={(event) => handleZoneKeydown(event, 'banquet-hall')}>
    ...
    <g id="t1-vvip-quarters" role="button" tabindex="0" aria-label="Open VVIP Living Quarters" onclick={() => handleZoneClick('vvip-living-quarters')} onkeydown={(event) => handleZoneKeydown(event, 'vvip-living-quarters')}>
    ...
    <!-- VIP Casino -->
    <g id="t1-casino" role="button" tabindex="0" aria-label="Open VIP Casino" onclick={() => handleZoneClick('casino')} onkeydown={(event) => handleZoneKeydown(event, 'casino')}>
    ...
    <g id="t1-queens-quarters" role="button" tabindex="0" aria-label="Open Queens' Living Quarters" onclick={() => handleZoneClick('queens-living-quarters')} onkeydown={(event) => handleZoneKeydown(event, 'queens-living-quarters')}>
    ...
    <g id="t1-princes-quarters">
      ...
      {#each [2, 4, 6, 8, 10, 12, 14] as i, index}
        <g role="button" tabindex="0" aria-label={`Open Room 10${i < 10 ? '0'+i : i}`} onclick={(e) => { e.stopPropagation(); handleZoneClick(`room-10${i < 10 ? '0'+i : i}`); }} onkeydown={(event) => handleZoneKeydown(event, `room-10${i < 10 ? '0'+i : i}`)}>
    ...
    <g id="t1-soldiers-quarters" role="button" tabindex="0" aria-label="Open Soldiers' Living Quarters" onclick={() => handleZoneClick('soldiers-living-quarters')} onkeydown={(event) => handleZoneKeydown(event, 'soldiers-living-quarters')}>
    ...
    <g id="t1-lifeboats" role="button" tabindex="0" aria-label="Open Lifeboats" onclick={() => handleZoneClick('lifeboats')} onkeydown={(event) => handleZoneKeydown(event, 'lifeboats')}>
      <!-- Left side lifeboats -->
