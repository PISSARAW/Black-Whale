...
const STATIC_SOUND: Partial<Record<TourReport['kind'], () => void>> = {
  ...
  // Guardian Spirit Beasts and other summoned things: the big ones gnash, the
  // long ones coil, the curses mark, and the swarms buzz.
  'beast-raised': gnash,
  'beast-dismissed': gnash,
  'double-posted': gnash,
  'guards-posted': gnash,
  'wheel-raised': gnash,
  'wheel-dismissed': gnash,
  'bait-set': coil,
  trapped: coil,
  'snakes-loosed': coil,
  'snakes-fed': coil,
  'curse-fell': curseSet,
  'marked-victim': curseSet,
  'name-taken': curseSet,
  'flock-called-in': swarm,
  'halo-raised': swarm,
  'room-brightened': swarm,
  'gas-loosed': gnash,
  'gas-lifted': gnash,
  'smoke-loosed': gnash,
  'smoke-lifted': gnash,
  // The chimera's lie marks three stages; all are the same beast touching.
  'lie-pushed': gnash,
  'lie-greened': gnash,
