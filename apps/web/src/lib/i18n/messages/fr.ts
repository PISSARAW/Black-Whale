...
export const fr: Messages = {
  ...
  reconstruction: {
    ...
    v3: {
      ...
      seoTitle: 'Reconstruction V3 — Black Whale',
      seoDescription: 'Construisez, rejouez et expliquez une branche causale du Black Whale.',
      canonicalBack: 'Reconstruction canonique',
      eyebrow: 'Laboratoire causal · V3',
      title: 'Et si une décision avait changé ?',
      intro:
        'Composez une branche compatible avec les règles, exécutez ses Hatsu réels et mesurez précisément où elle quitte le canon.',
      divergencePoint: 'Point de divergence',
      spoilerNote: 'Le filtre spoiler s’applique aussi à la simulation.',
      titleLabel: 'Titre',
      defaultTitle: 'Nouvelle branche contrefactuelle',
      canonicalEvent: 'Événement canonique',
      eventNumber: (index) => `Événement canonique ${index}`,
      chapter: 'Chap.',
      policy: 'Politique',
      policies: { compatible: 'Compatible avec les règles', strict: 'Canon strict' },
      decisions: 'Décisions',
      decisionsIntro: 'Chaque décision peut dépendre d’un fait causal vérifiable.',
      type: 'Type',
      actor: 'Acteur',
      ...
      hatsuAction: 'Action moteur',
      causalPrecondition: 'Ajouter une précondition causale',
      condition: 'Condition',
      conditions: {
        entityAt: 'Présence',
        knowsFact: 'Connaissance',
        abilityAvailable: 'Hatsu disponible',
        eventOccurred: 'Événement survenu',
      },
      subject: 'Sujet',
      defaultActor: 'acteur par défaut',
      expectedValue: 'Valeur attendue',
      addDecision: 'Ajouter la décision',
      removeDecision: 'Supprimer',
      running: 'Simulation…',
      run: 'Exécuter la branche',
      copied: 'Lien copié',
      share: 'Partager le scénario',
      report: 'Rapport de divergence',
      fidelity: 'Fidélité',
      branch: 'Branche',
      firstDivergence: 'Premier écart',
      none: 'aucun',
      differences: 'Différences canon / branche',
      noDifferences: 'Aucune différence sur les axes comparés.',
      reportSummary: (subjects, axes) =>
        subjects === 0
          ? 'La branche rejoint l’état canonique sur les axes comparés.'
          : `${subjects} sujet${subjects === 1 ? '' : 's'} diverge${subjects === 1 ? '' : 'nt'} sur ${axes} axe${axes === 1 ? '' : 's'}.`,
      decisiveHatsu: 'Hatsu décisifs',
      unappliedDecisions: 'Décisions non appliquées',
      assumptions: 'Hypothèses et replay déterministe',
      scene: {
        title: 'Scène interactive',
        hint: 'Armez le Hatsu puis visez avec le réticule.',
        arm: 'Armer le Hatsu',
        unavailable: 'Animation indisponible',
        move: 'Se déplacer',
        cast: 'Lancer',
        silence: 'Couper le son',
        restore: 'Rétablir le son',
        loading: 'Chargement de la scène…',
        unsupported: 'WebGL est requis pour la scène interactive.',
        rebound: 'Le contrecoup force le Zetsu.',
        vow: (spaceId) => `Le pacte interdit de quitter ${spaceId}.`,
      },
      errors: {
        requiredFields: 'Événement, Hatsu et acteur requis.',
        unknownFork: 'Point de divergence inconnu ou masqué.',
        rateLimited: (seconds) => `Trop de simulations. Réessayez dans ${seconds} s.`,
        invalidScenario: 'Scénario invalide',
        actionsUnavailable: 'Actions du Hatsu indisponibles.',
        invalidShared: 'Le scénario partagé est invalide ou a été altéré.',
        characterAndDestination: 'Choisissez un personnage et une destination.',
        knowledgeFields: 'L’émetteur, le destinataire et le fait sont requis.',
        hatsuFields: 'Le Hatsu, son action, l’acteur et la cible sont requis.',
        simulationFailed: 'La simulation a échoué.',
      },
    },
  },
  ...
  tour: {
    ...
    postcard: {
      ...
      stamp: 'Tampon :',
      stampHint: 'Chaque sceau réinvente le tempérament de son propriétaire à bord.',
      stampCategories: {
        official: 'Vaisseau et autorités',
        royal: 'Les quatorze princes',
        underworld: 'Passagers clandestins',
        expedition: "Équipes de l'expédition",
      },
      stamps: {
        kakin: { name: 'Empire Kakin', title: 'EMPIRE KAKIN', motto: 'VIP OFFICIEL' },
        hunter: {
          name: 'Association des Hunters',
          title: 'ASSOC. HUNTER',
          motto: 'ENNUI LICENCIÉ',
        },
        blackWhale: {
          name: 'Black Whale no 1',
          title: 'BLACK WHALE No. 1',
          motto: 'ALLER SIMPLE · 1re CLASSE',
        },
        royalArmy: { name: 'Armée royale de Kakin', title: 'ARMÉE ROYALE', motto: 'AUCUNE EXCUSE' },
        justice: {
          name: 'Bureau de la Justice de Kakin',
          title: 'BUREAU DE JUSTICE',
          motto: 'LA LOI NE SOURIT PAS',
        },
        police: { name: 'Police centrale', title: 'POLICE CENTRALE', motto: 'TIER VÉRIFIÉ' },
        tribunal: {
          name: 'Tribunal central',
          title: 'TRIBUNAL CENTRAL',
          motto: 'FORMULAIRE 12-B EXIGÉ',
        },
        hospital: { name: 'Hôpital central', title: 'HÔPITAL CENTRAL', motto: 'RESPIRE ENCORE' },
        passengerControl: {
          name: 'Contrôle des passagers',
          title: 'CONTRÔLE PASSAGERS',
          motto: 'COMPTÉS · PLUS OU MOINS',
        },
        succession: {
          name: 'Guerre de Succession',
          title: 'SUCCESSION',
          motto: 'UN TRÔNE · 14 PRÉTENDANTS',
        },
        seedUrn: { name: "Cérémonie de l'Urne", title: 'URNE AUX GRAINES', motto: 'SANS RETOUR' },
        darkContinent: {
          name: 'Expédition du Continent obscur',
          title: 'CONTINENT OBSCUR',
          motto: 'AUTORISÉ À APPROCHER',
        },
        beyond: {
          name: 'Expédition de Beyond',
          title: 'BEYOND NETERO',
          motto: 'PLUS LOIN QUE PERMIS',
        },
        permits: {
          name: 'Agence internationale des permis',
          title: 'PERMIS INTERNAT.',
          motto: 'INDICE DE RISQUE : OUI',
        },
        v6: { name: 'Délégation du V6', title: 'DÉLÉGATION V6', motto: 'SIX DRAPEAUX · UNE NOTE' },
        benjamin: { name: 'Prince Benjamin', title: 'BENJAMIN', motto: 'AUCUNE EXCUSE' },
        camilla: { name: 'Princesse Camilla', title: 'CAMILLA', motto: 'DÉJÀ PARDONNÉE' },
        zhangLei: { name: 'Prince Zhang Lei', title: 'ZHANG LEI', motto: 'LES INTÉRÊTS COURENT' },
        tserriednich: {
          name: 'Prince Tserriednich',
          title: 'TSERRIEDNICH',
          motto: 'AUCUN COMMENTAIRE',
        },
        tubeppa: { name: 'Princesse Tubeppa', title: 'TUBEPPA', motto: 'VALIDÉ PAR LES PAIRS' },
        tyson: { name: 'Princesse Tyson', title: 'TYSON', motto: "L'AMOUR EST OBLIGATOIRE" },
        luzurus: { name: 'Prince Luzurus', title: 'LUZURUS', motto: 'VALIDÉ, JE SUPPOSE' },
        saleSale: { name: 'Prince Sale-Sale', title: 'SALE-SALE', motto: 'VIP ÉTERNEL' },
        halkenburg: {
          name: 'Prince Halkenburg',
          title: 'HALKENBURG',
          motto: 'UNE FLÈCHE · UNE VOIX',
        },
        kacho: { name: 'Princesse Kacho', title: 'KACHO', motto: 'GARDE LA CHANSON' },
        fugetsu: { name: 'Princesse Fugetsu', title: 'FUGETSU', motto: 'LA PORTE EST OUVERTE' },
        momoze: { name: 'Princesse Momoze', title: 'MOMOZE', motto: 'REPOSEZ-VOUS DONC' },
        marayam: { name: 'Prince Marayam', title: 'MARAYAM', motto: 'DRAGON DE GARDE' },
        woble: { name: 'Prince Woble', title: 'WOBLE', motto: 'APPROUVÉ PAR GAZOUILLIS' },
        xiYu: { name: 'Famille Xi-Yu', title: 'XI-YU', motto: 'AFFAIRE RÉGLÉE' },
        chaR: { name: 'Famille Cha-R', title: 'CHA-R', motto: 'GARDEZ ÇA EN BAS' },
        heilLy: { name: 'Famille Heil-Ly', title: 'HEIL-LY', motto: 'MONTER · TOUT CASSER' },
        phantomTroupe: { name: 'Brigade fantôme', title: 'BRIGADE FANTÔME', motto: 'MEMBRE No __' },
        zoldyck: { name: 'Famille Zoldyck', title: 'ZOLDYCK', motto: 'NI TÉMOIN · NI REÇU' },
        hisoka: { name: "Marque d'Hisoka", title: 'HISOKA', motto: "TU AS L'AIR PROMETTEUR" },
        zodiacs: { name: 'Zodiaques', title: 'ZODIAQUES', motto: 'DOUZE AVIS' },
        science: {
          name: 'Équipe scientifique',
          title: 'ÉQUIPE SCIENTIFIQUE',
          motto: "NE PAS LÉCHER L'ÉCHANTILLON",
        },
        medical: { name: 'Équipe médicale', title: 'ÉQUIPE MÉDICALE', motto: 'AU SUIVANT' },
        defense: {
          name: 'Équipe de défense',
          title: 'ÉQUIPE DE DÉFENSE',
          motto: 'RESTEZ DERRIÈRE LA LIGNE',
        },
        intelligence: {
          name: 'Équipe de renseignement',
          title: 'RENSEIGNEMENT',
          motto: "CE TAMPON N'EXISTE PAS",
        },
        beyondCustody: {
          name: 'Équipe de détention de Beyond',
          title: 'DÉTENTION BEYOND',
          motto: 'TOUJOURS LÀ. HÉLAS.',
        },
      },
    ...
    comfort: {
      ...
      shipHour: 'Heure du bord',
      hourCanon: 'Celle du chapitre',
      hourMorning: 'Matin',
      hourNoon: 'Midi',
      hourEvening: 'Soir',
      hourNight: 'Nuit',
      ...
      qualityLow: 'Allégée',
      qualityHigh: 'Complète',
      qualityHelp: 'Prend effet au prochain chargement de la visite.',
    ...
    room: {
      ...
      solids: {
        ...
        mobile: (count) => `${count} ${count === 1 ? 'mobile' : 'mobiles'}`,
    ...
    examine: {
      ...
      claims: {
        ...
        mobile: 'Un nourrisson est installé ici, sous le jouet suspendu que la case montre.',
    ...
    hatsu: {
      ...
      reports: {
        ...
        noInjury:
          "Rien à empaqueter · subissez d'abord une blessure physique avant d'enfiler l'armure",
        fingersIntact:
  ...
  hunt: {
    ...
    editor: {
      seoTitle: 'Éditeur de contrat de traque',
      eyebrow: 'Traque V3',
      ...
      duration: 'Durée',
      lighting: 'Éclairage',
      lightingOptions: { normal: 'Normal', low: 'Faible', blackout: 'Coupure totale' },
      acoustics: 'Acoustique',
      acousticsOptions: { clear: 'Claire', reverberant: 'Réverbérante', masked: 'Masquée' },
      playAndShare: 'Jouer et partager ce contrat',
      description: 'Un contrat de traque créé par un joueur.',
    },
    briefing: {
  ...
  timeline: {
    ...
    hatsuUses: 'Hatsu liés à cet événement',
    chapterHatsu: 'Hatsu révélés sans nouvelle scène à bord',
    hatsuUseStatuses: {
      ACTIVATED: 'activé',
      MAINTAINED: 'maintenu',
      REVEALED: 'révélé',
  ...
  ship: {
    ...
    track: 'Suivre',
    trackAria: 'Suivre un personnage ou un objet important',
    objectTracking: {
      characters: 'Personnages',
      objects: 'Objets importants',
      unknownPosition: 'Position actuelle inconnue',
      sinceChapter: (chapter) => `Depuis le chapitre ${chapter}`,
      markerAria: (name, location) => `${name}, suivi à ${location}`,
    },
    ...
    scanReadout: (zones, presences) =>
      `${zones} zones cartographiées · ${presences} entités suivies`,
  ...
  strategy: {
    ui: {
      ...
      checkConnection: 'Vérifiez la connexion aux serveurs tactiques.',
      initializing: 'Initialisation du réseau tactique…',
      campaignOperations: 'Opérations de campagne',
      operation: (index, chapter) => `Opération ${index} · Chapitre ${chapter}`,
      backToFactions: 'Factions',
      tacticalNetwork: 'RÉSEAU TACTIQUE',
      turn: 'Tour',
      scheduledEvent: 'Événement planifié',
      currentObjective: 'OBJECTIF ACTUEL',
      objectiveUnavailable: 'Objectif indisponible',
      tacticalAnalysis: 'Analyse de la situation tactique en cours.',
      completed: 'accompli',
      influence: 'INFLUENCE',
      newOrder: 'Nouvel ordre',
      action: 'Action',
      orderOptions: {
        MOVE: 'Déplacement · 1 PC',
        SCOUT: 'Investigation · 2 PC',
        GUARD: 'Garde sur place · 1 PC',
        HATSU: 'Activer Hatsu · 3 PC',
      },
      orderLabels: {
        MOVE: 'Déplacement',
        SCOUT: 'Investigation',
      ...
      hatsuRoles: {
        RECON: 'Révèle les présences hostiles dans la zone ciblée.',
        MOBILITY: 'Déplace instantanément l’unité dans la zone ciblée.',
        DENIAL: 'Empêche les mouvements hostiles vers la zone pendant ce tour.',
      },
      chooseAbility: 'Sélectionner une capacité',
      availableTurn: (turn) => `dispo tour ${turn}`,
      noTacticalHatsu: 'Aucun Hatsu tactique connu pour cette unité.',
      unit: 'Unité',
      chooseUnit: 'Sélectionner une unité',
      destinations: { scout: 'Zone à investiguer', hatsu: 'Cible', move: 'Destination' },
      chooseZone: 'Sélectionner une zone',
      addToPlan: 'Ajouter au plan',
      operationalSequence: 'Séquence opérationnelle',
      removeOrder: (name) => `Retirer l’ordre de ${name}`,
      emptyPlan: 'Aucun ordre : finaliser le tour passera l’action.',
      tacticalLog: 'Registre tactique',
      strategicVictory: 'Victoire stratégique',
      operationEnded: 'Opération terminée',
      executeTurn: (points) => `Exécuter le tour · ${points} PC`,
      restrictedSituation: 'SITUATION TACTIQUE · DONNÉES RESTREINTES',
      yourUnits: 'Vos unités',
      observedContacts: 'Contacts observés',
      unknownPosition: 'Position inconnue',
      conditions: { READY: 'Opérationnelle', WOUNDED: 'Blessée', ELIMINATED: 'Éliminée' },
      picker: {
        scenario: (chapter) => `Scénario tactique · Chapitre ${chapter ?? '—'}`,
        title: 'Choisir une faction',
        intro:
          'Huit tours pour imposer votre doctrine. Les ordres tactiques, négociations diplomatiques et Hatsu partagent le même pool de points de commandement.',
        resume: (turn) => `Reprendre l’opération · tour ${turn}`,
        activeUnits: (count) =>
          `${count} unité${count === 1 ? '' : 's'} active${count === 1 ? '' : 's'}`,
        begin: 'Initier le commandement',
        none: 'Aucune faction active détectée à ce stade du récit.',
      },
      diplomacy: {
        title: 'Diplomatie',
        ...
        trust: 'Confiance',
        fear: 'Crainte',
        activePact: 'Pacte actif',
        counterpart: 'Interlocuteur',
        chooseFaction: 'Sélectionner une faction',
        proposal: 'Proposition',
        options: {
          SHARE_INTEL: 'Partager des renseignements · 1 PC',
          PROPOSE_PACT: 'Proposer une alliance · 2 PC',
          THREATEN: 'Faire pression · 1 PC',
          BETRAY: 'Rompre le pacte · 0 PC',
        },
        formulate: 'Formuler la proposition',
      },
      debrief: {
        finalReport: (turn) => `Rapport final · Tour ${turn}`,
        compromised: 'Opération compromise',
        influencePoints: (points) => `${points} point${points === 1 ? '' : 's'} d’influence`,
        replay: 'Rejouer le scénario',
        continue: 'Continuer la campagne',
      },
      battlefield: {
        label: 'Vue du champ de bataille',
        tour: 'Vue 3D',
        map: 'Carte tactique',
        displayDeck: 'Afficher le pont',
        deck: (tier) => tier.replace('tier-', 'Pont '),
        move: 'Déplacement',
        cast: 'Action',
        silence: 'Couper les bruits de pas',
        restore: 'Rétablir les bruits de pas',
        loading: 'Chargement du Black Whale…',
        unsupported: 'La vue 3D exige WebGL. Utilisez la carte tactique.',
        empty: 'Aucune donnée sur ce pont.',
        elsewhere: (count) => `${count} unité${count === 1 ? '' : 's'} sur d’autres ponts.`,
      },
    },
    hatsu: {
    ...
    errors: {
      factionUnknown: 'Faction inconnue.',
      simulationNotReady: 'La simulation n’est pas prête.',
      scenarioEnded: 'Le scénario est terminé.',
      activeFactionMismatch: 'La faction active ne correspond pas au plan.',
      commandPointsExceeded: (points) => `Le plan dépasse les ${points} points de commandement.`,
      planExceedsPoints: 'Ce plan dépasse vos points de commandement.',
      diplomacyExceedsPoints: 'Cette action diplomatique dépasse vos points de commandement.',
      turnFailed: 'Le tour a échoué. Aucun ordre n’a été appliqué.',
      loadFailed: 'Le scénario stratégique n’a pas pu être initialisé.',
      unitLacksHatsu: 'Cette unité ne maîtrise pas le Hatsu sélectionné.',
      hatsuCoolingDown: 'Ce Hatsu est encore en récupération.',
      unknownHatsu: 'Hatsu inconnu du registre tactique.',
    ...
    reports: {
      initialized: 'Simulation initialisée.',
      briefing: (doctrine) => `Briefing reçu · ${doctrine}`,
      opposition: (names) => `Opposition identifiée : ${names || 'aucune'}.`,
      hiddenPositions:
        'Les positions adverses restent inconnues tant qu’elles ne sont pas observées.',
      catsName: 'Cat’s Name se déclenche : Camilla revient à la vie et son meurtrier est consumé.',
      catsNameShort: 'Cat’s Name se déclenche.',
      alliedHit: (location) => `Une unité alliée est touchée en ${location}.`,
      hostileHit: (location) => `Une unité adverse est neutralisée en ${location}.`,
      diplomacy: {
        shared: 'Le partage de renseignements améliore la confiance.',
        pressure: 'La pression est comprise, mais la confiance diminue.',
        betrayed: 'Le pacte est rompu. Cette trahison restera dans les mémoires.',
        noPact: 'Aucun pacte à rompre.',
        pactAccepted: 'Le pacte de non-agression est accepté.',
        pactRefused: 'La proposition de pacte est refusée.',
        missingFaction: 'Une action diplomatique vise une faction absente.',
        onePerFaction: 'Une seule action diplomatique est autorisée par faction.',
      },
      turn: {
        event: (title, description) => `Événement · ${title} — ${description}`,
        resolved: (turn, orders, discoveries) =>
          `Tour ${turn} · ${orders} ordre${orders === 1 ? '' : 's'} résolu${orders === 1 ? '' : 's'}, ${discoveries} mise${discoveries === 1 ? '' : 's'} à jour du renseignement.`,
        interceptions: (count) =>
          `Interception réussie : ${count} mouvement${count === 1 ? '' : 's'} hostile${count === 1 ? '' : 's'} bloqué${count === 1 ? '' : 's'}.`,
        hatsu: (activation) => `Hatsu activé · ${activation}.`,
        hostileNen: 'Activité Nen hostile détectée.',
        blockedMoves: (count) =>
          `Contrôle hostile · ${count} mouvement${count === 1 ? '' : 's'} allié${count === 1 ? '' : 's'} bloqué${count === 1 ? '' : 's'}.`,
        contacts: (count) =>
          `Contact hostile dans ${count} zone${count === 1 ? '' : 's'}. Position ennemie confirmée.`,
        objective: (points) => `Objectif accompli · ${points}/3 points de victoire.`,
        victory: 'Victoire stratégique obtenue.',
        defeat: 'Défaite stratégique · le temps est écoulé.',
        scouted: (count) => `Investigation terminée dans ${count} zone${count === 1 ? '' : 's'}.`,
        guarded: (count) => `Protection maintenue dans ${count} zone${count === 1 ? '' : 's'}.`,
      },
    },
  },
