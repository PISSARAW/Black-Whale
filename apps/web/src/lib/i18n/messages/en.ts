...
export const en = {
  ...
  reconstruction: {
    ...
    v3: {
      ...
      seoDescription: 'Build, replay and explain a causal branch aboard the Black Whale.',
      canonicalBack: 'Canonical reconstruction',
      eyebrow: 'Causal laboratory · V3',
      title: 'What if one decision had changed?',
      intro:
        'Build a rules-compatible branch, execute its real Hatsu and measure precisely where it leaves canon.',
      divergencePoint: 'Divergence point',
      spoilerNote: 'The spoiler filter also applies to the simulation.',
      titleLabel: 'Title',
      defaultTitle: 'New counterfactual branch',
      canonicalEvent: 'Canonical event',
      eventNumber: (index: number) => `Canonical event ${index}`,
      chapter: 'Ch.',
      policy: 'Policy',
      policies: { compatible: 'Rules-compatible', strict: 'Strict canon' },
      decisions: 'Decisions',
      decisionsIntro: 'Each decision may depend on a verifiable causal fact.',
      type: 'Type',
      actor: 'Actor',
      ...
      hatsuAction: 'Engine action',
      causalPrecondition: 'Add a causal precondition',
      condition: 'Condition',
      conditions: {
        entityAt: 'Presence',
        knowsFact: 'Knowledge',
        abilityAvailable: 'Hatsu available',
      ...
      none: 'none',
      differences: 'Canon / branch differences',
      noDifferences: 'No difference on the compared axes.',
      reportSummary: (subjects: number, axes: number) =>
        subjects === 0
          ? 'The branch rejoins the canonical state on the compared axes.'
          : `${subjects} subject${subjects === 1 ? '' : 's'} diverge on ${axes} axis${axes === 1 ? '' : 'es'}.`,
      decisiveHatsu: 'Decisive Hatsu',
      unappliedDecisions: 'Unapplied decisions',
      assumptions: 'Assumptions and deterministic replay',
      scene: {
        title: 'Interactive scene',
        hint: 'Arm the Hatsu, then aim with the reticle.',
        arm: 'Arm Hatsu',
        unavailable: 'Animation unavailable',
        move: 'Move',
        cast: 'Cast',
        silence: 'Mute sound',
        restore: 'Restore sound',
        loading: 'Loading scene…',
        unsupported: 'WebGL is required for the interactive scene.',
        rebound: 'The backlash forces Zetsu.',
        vow: (spaceId: string) => `The pact forbids leaving ${spaceId}.`,
      },
      errors: {
        requiredFields: 'Event, Hatsu and actor are required.',
        unknownFork: 'The divergence point is unknown or hidden.',
        rateLimited: (seconds: number) => `Too many simulations. Try again in ${seconds}s.`,
        invalidScenario: 'Invalid scenario',
        actionsUnavailable: 'Hatsu actions are unavailable.',
        invalidShared: 'The shared scenario is invalid or has been altered.',
        characterAndDestination: 'Choose a character and a destination.',
        knowledgeFields: 'The sender, recipient and fact are required.',
        hatsuFields: 'The Hatsu, its action, actor and target are required.',
        simulationFailed: 'The simulation failed.',
      },
    },
  },
  ...
  tour: {
    ...
    postcard: {
      ...
      stamp: 'Stamp:',
      stampHint: 'Every seal was invented from the temperament of its owner aboard the ship.',
      stampCategories: {
        official: 'Ship & authorities',
        royal: 'The fourteen princes',
        underworld: 'Underworld passengers',
        expedition: 'Expedition teams',
      },
      stamps: {
        kakin: { name: 'Kakin Empire', title: 'KAKIN EMPIRE', motto: 'OFFICIAL VIP' },
        hunter: { name: 'Hunter Association', title: 'HUNTER ASSOC.', motto: 'LICENSED TROUBLE' },
        blackWhale: {
          name: 'Black Whale No. 1',
          title: 'BLACK WHALE No. 1',
          motto: 'ONE WAY · FIRST CLASS',
        },
        royalArmy: { name: 'Kakin Royal Army', title: 'ROYAL ARMY', motto: 'NO EXCUSES' },
        justice: {
          name: 'Kakin Justice Bureau',
          title: 'JUSTICE BUREAU',
          motto: 'THE LAW DOES NOT SMILE',
        },
        police: { name: 'Central Police', title: 'CENTRAL POLICE', motto: 'TIER VERIFIED' },
        tribunal: { name: 'Central Court', title: 'CENTRAL COURT', motto: 'FORM 12-B REQUIRED' },
        hospital: { name: 'Central Hospital', title: 'CENTRAL HOSPITAL', motto: 'STILL BREATHING' },
        passengerControl: {
          name: 'Passenger Control',
          title: 'PASSENGER CONTROL',
          motto: 'COUNTED · MOSTLY',
        },
        succession: {
          name: 'Succession Contest',
          title: 'SUCCESSION',
          motto: 'ONE THRONE · FOURTEEN CLAIMS',
        },
        seedUrn: { name: 'Seed Urn Ceremony', title: 'SEED URN', motto: 'NO RETURNS' },
        darkContinent: {
          name: 'Dark Continent Expedition',
          title: 'DARK CONTINENT',
          motto: 'AUTHORIZED TO APPROACH',
        },
        beyond: {
          name: "Beyond's Expedition",
          title: 'BEYOND NETERO',
          motto: 'FURTHER THAN PERMITTED',
        },
        permits: {
          name: 'International Permit Agency',
          title: 'INTL. PERMITS',
          motto: 'RISK INDEX: YES',
        },
        v6: { name: 'V6 Delegation', title: 'V6 DELEGATION', motto: 'SIX FLAGS · ONE BILL' },
        benjamin: { name: 'Prince Benjamin', title: 'BENJAMIN', motto: 'NO EXCUSES' },
        camilla: { name: 'Princess Camilla', title: 'CAMILLA', motto: 'ALREADY FORGIVEN' },
        zhangLei: { name: 'Prince Zhang Lei', title: 'ZHANG LEI', motto: 'INTEREST COMPOUNDS' },
        tserriednich: { name: 'Prince Tserriednich', title: 'TSERRIEDNICH', motto: 'NO COMMENT' },
        tubeppa: { name: 'Princess Tubeppa', title: 'TUBEPPA', motto: 'PEER REVIEWED' },
        tyson: { name: 'Princess Tyson', title: 'TYSON', motto: 'LOVE IS MANDATORY' },
        luzurus: { name: 'Prince Luzurus', title: 'LUZURUS', motto: 'APPROVED, I GUESS' },
        saleSale: { name: 'Prince Sale-Sale', title: 'SALE-SALE', motto: 'ETERNAL VIP' },
        halkenburg: {
          name: 'Prince Halkenburg',
          title: 'HALKENBURG',
          motto: 'ONE ARROW · ONE VOICE',
        },
        kacho: { name: 'Princess Kacho', title: 'KACHO', motto: 'KEEP THE SONG' },
        fugetsu: { name: 'Princess Fugetsu', title: 'FUGETSU', motto: 'THE DOOR IS OPEN' },
        momoze: { name: 'Princess Momoze', title: 'MOMOZE', motto: 'PLEASE, HAVE SOME REST' },
        marayam: { name: 'Prince Marayam', title: 'MARAYAM', motto: 'DRAGON ON GUARD' },
        woble: { name: 'Prince Woble', title: 'WOBLE', motto: 'APPROVED BY BABBLE' },
        xiYu: { name: 'Xi-Yu Family', title: 'XI-YU', motto: 'BUSINESS SETTLED' },
        chaR: { name: 'Cha-R Family', title: 'CHA-R', motto: 'KEEP IT DOWNSTAIRS' },
        heilLy: { name: 'Heil-Ly Family', title: 'HEIL-LY', motto: 'LEVEL UP · BREAK EVERYTHING' },
        phantomTroupe: { name: 'Phantom Troupe', title: 'PHANTOM TROUPE', motto: 'MEMBER No. __' },
        zoldyck: { name: 'Zoldyck Family', title: 'ZOLDYCK', motto: 'NO WITNESSES · NO RECEIPT' },
        hisoka: { name: "Hisoka's mark", title: 'HISOKA', motto: 'YOU LOOK PROMISING' },
        zodiacs: { name: 'Zodiacs', title: 'ZODIACS', motto: 'TWELVE OPINIONS' },
        science: { name: 'Science Team', title: 'SCIENCE TEAM', motto: 'DO NOT LICK THE SAMPLE' },
        medical: { name: 'Medical Team', title: 'MEDICAL TEAM', motto: 'NEXT PATIENT' },
        defense: { name: 'Defense Team', title: 'DEFENSE TEAM', motto: 'STAY BEHIND THE LINE' },
        intelligence: {
          name: 'Intelligence Team',
          title: 'INTELLIGENCE',
          motto: 'THIS STAMP DOES NOT EXIST',
        },
        beyondCustody: {
          name: "Beyond's Custody Team",
          title: 'BEYOND CUSTODY',
          motto: 'STILL HERE. UNFORTUNATELY.',
        },
      },
    ...
    comfort: {
      ...
      hourNight: 'Night',
      shipHourHelp:
        'Only the two windows show an outside. Everywhere else the ship makes the day itself: its lamps are tunable, and they run white and high through the middle of the day, warm and lower at night — with the hall kept lit for the evening. No room goes dark.',
      /**
    ...
    room: {
      ...
      solids: {
        ...
        mobile: (count: number) => `${count} ${count === 1 ? 'mobile' : 'mobiles'}`,
    ...
    examine: {
      ...
      claims: {
        ...
        mobile: 'A baby is kept here, beneath the hanging toy the panel shows.',
  ...
  hunt: {
    ...
    editor: {
      ...
      duration: 'Duration',
      lighting: 'Lighting',
      lightingOptions: { normal: 'Normal', low: 'Low', blackout: 'Blackout' },
      acoustics: 'Acoustics',
      acousticsOptions: { clear: 'Clear', reverberant: 'Reverberant', masked: 'Masked' },
      playAndShare: 'Play and share this contract',
      description: 'A player-authored Hunt contract.',
    },
    briefing: {
  ...
  timeline: {
    ...
    hatsuUses: 'Hatsu tied to this event',
    chapterHatsu: 'Hatsu revealed without a new shipboard scene',
    hatsuUseStatuses: {
      ACTIVATED: 'activated',
  ...
  ship: {
    ...
    track: 'Track',
    trackAria: 'Track a character or important object',
    objectTracking: {
      characters: 'Characters',
      objects: 'Important objects',
      unknownPosition: 'Current position unknown',
      sinceChapter: (chapter: number) => `Since chapter ${chapter}`,
      markerAria: (name: string, location: string) => `${name}, tracked at ${location}`,
    },
    ...
    scanReadout: (zones: number, presences: number) =>
      `${zones} mapped zones · ${presences} tracked entities`,
  ...
  strategy: {
    ui: {
      ...
      checkConnection: 'Check the connection to the tactical servers.',
      initializing: 'Initializing tactical network…',
      campaignOperations: 'Campaign operations',
      operation: (index: number, chapter: number) => `Operation ${index} · Chapter ${chapter}`,
      backToFactions: 'Factions',
      tacticalNetwork: 'TACTICAL NETWORK',
      turn: 'Turn',
      scheduledEvent: 'Scheduled event',
      currentObjective: 'CURRENT OBJECTIVE',
      objectiveUnavailable: 'Objective unavailable',
      tacticalAnalysis: 'Current tactical situation analysis.',
      completed: 'completed',
      influence: 'INFLUENCE',
      newOrder: 'New order',
      action: 'Action',
      orderOptions: {
        MOVE: 'Move · 1 CP',
        SCOUT: 'Investigate · 2 CP',
        GUARD: 'Guard in place · 1 CP',
        HATSU: 'Activate Hatsu · 3 CP',
      },
      orderLabels: { MOVE: 'Move', SCOUT: 'Investigate', GUARD: 'Guard', HATSU: 'Activate Hatsu' },
      hatsuRoles: {
        RECON: 'Reveals hostile presences in the targeted area.',
        MOBILITY: 'Instantly moves the unit to the targeted area.',
        DENIAL: 'Prevents hostile movements into the area this turn.',
      },
      chooseAbility: 'Select an ability',
      availableTurn: (turn: number) => `available turn ${turn}`,
      noTacticalHatsu: 'No known tactical Hatsu for this unit.',
      unit: 'Unit',
      chooseUnit: 'Select a unit',
      destinations: { scout: 'Area to investigate', hatsu: 'Target', move: 'Destination' },
      chooseZone: 'Select an area',
      addToPlan: 'Add to plan',
      operationalSequence: 'Operational sequence',
      removeOrder: (name: string) => `Remove ${name}'s order`,
      emptyPlan: 'No orders: ending the turn will pass the action.',
      tacticalLog: 'Tactical log',
      strategicVictory: 'Strategic victory',
      operationEnded: 'Operation ended',
      executeTurn: (points: number) => `Execute turn · ${points} CP`,
      restrictedSituation: 'TACTICAL SITUATION · RESTRICTED DATA',
      yourUnits: 'Your units',
      observedContacts: 'Observed contacts',
      unknownPosition: 'Unknown position',
      conditions: { READY: 'Operational', WOUNDED: 'Wounded', ELIMINATED: 'Eliminated' },
      picker: {
        scenario: (chapter: number | undefined) => `Tactical scenario · Chapter ${chapter ?? '—'}`,
        title: 'Choose a faction',
        intro:
          'Eight turns to impose your doctrine. Tactical orders, diplomatic negotiations and Hatsu share the same command-point pool.',
        resume: (turn: number) => `Resume operation · turn ${turn}`,
        activeUnits: (count: number) => `${count} active unit${count === 1 ? '' : 's'}`,
        begin: 'Take command',
        none: 'No active faction detected at this point in the story.',
      },
      diplomacy: {
        title: 'Diplomacy',
        ...
        chooseFaction: 'Select a faction',
        proposal: 'Proposal',
        options: {
          SHARE_INTEL: 'Share intelligence · 1 CP',
          PROPOSE_PACT: 'Propose alliance · 2 CP',
          THREATEN: 'Apply pressure · 1 CP',
          BETRAY: 'Break pact · 0 CP',
        },
        formulate: 'Submit proposal',
      },
      debrief: {
        finalReport: (turn: number) => `Final report · Turn ${turn}`,
        compromised: 'Operation compromised',
        influencePoints: (points: number) => `${points} influence point${points === 1 ? '' : 's'}`,
        replay: 'Replay scenario',
        continue: 'Continue campaign',
      },
      battlefield: {
        label: 'Battlefield view',
        tour: '3D view',
        map: 'Tactical map',
        displayDeck: 'Display deck',
        deck: (tier: string) => tier.replace('tier-', 'Deck '),
        move: 'Movement',
        cast: 'Action',
        silence: 'Mute footsteps',
        restore: 'Restore footsteps',
        loading: 'Loading Black Whale…',
        unsupported: 'The 3D view requires WebGL. Use the tactical map.',
        empty: 'No data on this deck.',
        elsewhere: (count: number) => `${count} unit${count === 1 ? '' : 's'} on other decks.`,
      },
    },
    hatsu: {
    ...
    errors: {
      factionUnknown: 'Unknown faction.',
      simulationNotReady: 'The simulation is not ready.',
      scenarioEnded: 'The scenario is over.',
      activeFactionMismatch: 'The active faction does not match the plan.',
      commandPointsExceeded: (points: number) => `The plan exceeds ${points} command points.`,
      planExceedsPoints: 'This plan exceeds your command points.',
      diplomacyExceedsPoints: 'This diplomatic action exceeds your command points.',
      turnFailed: 'The turn failed. No orders were applied.',
      loadFailed: 'The strategy scenario could not be initialized.',
      unitLacksHatsu: 'This unit does not know the selected Hatsu.',
      hatsuCoolingDown: 'This Hatsu is still cooling down.',
      unknownHatsu: 'Unknown Hatsu in the tactical registry.',
    ...
    reports: {
      ...
      briefing: (doctrine: string) => `Briefing received · ${doctrine}`,
      opposition: (names: string) => `Opposition identified: ${names || 'none'}.`,
      hiddenPositions: 'Enemy positions remain unknown until observed.',
      catsName: "Cat's Name triggers: Camilla returns to life and her killer is consumed.",
      catsNameShort: "Cat's Name triggers.",
      alliedHit: (location: string) => `An allied unit is hit at ${location}.`,
      hostileHit: (location: string) => `A hostile unit is neutralized at ${location}.`,
      diplomacy: {
        shared: 'Shared intelligence improves trust.',
        pressure: 'The pressure is understood, but trust decreases.',
        betrayed: 'The pact is broken. This betrayal will be remembered.',
        noPact: 'No pact to break.',
        pactAccepted: 'The non-aggression pact is accepted.',
        pactRefused: 'The pact proposal is refused.',
        missingFaction: 'A diplomatic action targets a missing faction.',
        onePerFaction: 'Only one diplomatic action is allowed per faction.',
      },
      turn: {
        event: (title: string, description: string) => `Event · ${title} — ${description}`,
        resolved: (turn: number, orders: number, discoveries: number) =>
          `Turn ${turn} · ${orders} order${orders === 1 ? '' : 's'} resolved, ${discoveries} intelligence update${discoveries === 1 ? '' : 's'}.`,
        interceptions: (count: number) =>
          `Successful interception: ${count} hostile movement${count === 1 ? '' : 's'} blocked.`,
        hatsu: (activation: string) => `Hatsu activated · ${activation}.`,
        hostileNen: 'Hostile Nen activity detected.',
        blockedMoves: (count: number) =>
          `Hostile control · ${count} allied movement${count === 1 ? '' : 's'} blocked.`,
        contacts: (count: number) =>
          `Hostile contact in ${count} zone${count === 1 ? '' : 's'}. Enemy position confirmed.`,
        objective: (points: number) => `Objective achieved · ${points}/3 victory points.`,
        victory: 'Strategic victory achieved.',
        defeat: 'Strategic defeat · time has run out.',
        scouted: (count: number) =>
          `Investigation complete in ${count} zone${count === 1 ? '' : 's'}.`,
        guarded: (count: number) =>
          `Protection maintained in ${count} zone${count === 1 ? '' : 's'}.`,
      },
    },
  },
