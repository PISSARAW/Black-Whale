  ...
  <g transform="translate(50, 80)">
    ...
    {#each [0, 1, 2] as i}
      <g transform="translate({i * 300}, 50)">
        ...
        <line class="door" x1="100" y1="200" x2="120" y2="180" /> <!-- Door to main room -->
    ...
    <g transform="translate(350, 350)">
      ...
      <ellipse cx="40" cy="25" rx="15" ry="10" class="furniture" /> <!-- toilet -->
      <ellipse cx="80" cy="20" rx="8" ry="5" class="furniture" /> <!-- sink -->
