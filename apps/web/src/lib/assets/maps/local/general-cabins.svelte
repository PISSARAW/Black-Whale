...
>
  ...
  <text x="500" y="30" class="label" font-size="28" fill="#FFD700"
    >General Passenger Area (Tier 3)</text
  >
  <text x="500" y="55" class="sublabel text-gray-500"
    >Assembly Point (At least 5 sections: Area C, E...)</text
  >
  ...
  <g transform="translate(50, 80)">
    ...
    <rect
      ...
      width="900"
      height="200"
      onclick={() => handleElementClick('main-corridor')}
    />
    <text x="450" y="250" class="label text-gray-500" font-size="24" opacity="0.3"
      >Corridor Principal (Assembly Point)</text
    >
    ...
    {#each Array(6) as _, i (i)}
      <g transform="translate({i * 150}, 0)">
        ...
        <rect
          ...
          width="150"
          height="150"
          onclick={() => handleElementClick(`cabin-top-${i}`)}
        />
        ...
        <line class="wall" x1="40" y1="150" x2="110" y2="150" />
        <!-- Door frame -->
        <rect x="45" y="145" width="60" height="10" fill="#333" />
        <!-- Door closed -->
      </g>
    {/each}
    ...
    {#each Array(6) as _, i (i)}
      <g transform="translate({i * 150}, 350)">
        ...
        <rect
          ...
          width="150"
          height="150"
          onclick={() => handleElementClick(`cabin-bottom-${i}`)}
        />
        <text x="75" y="50" class="sublabel text-gray-600">Standard Cabin</text>

        {#if i === 4}
          <!-- Open Door showing inside -->
          <line class="door" x1="40" y1="0" x2="40" y2="60" />
          <!-- Door open inward -->
          <!-- Person sitting inside -->
          <circle cx="75" cy="50" r="15" fill="#aaa" />
          <text x="75" y="90" class="sublabel text-xs">Passenger</text>
        {:else}
          <line class="wall" x1="40" y1="0" x2="110" y2="0" />
          <!-- Door frame -->
          <rect x="45" y="-5" width="60" height="10" fill="#333" />
          <!-- Door closed -->
        {/if}
      </g>
    {/each}
