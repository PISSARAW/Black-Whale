<script lang="ts">
  /**
   * Tier 3-B, generated from `data/ship/blueprint.json`.
   *
  ...
  const regions: Region[] = [
    ...
    },
    {
      ...
      points: '180.0,100.0 360.0,100.0 360.0,250.0 180.0,250.0 180.0,210.0 240.0,210.0 240.0,180.0 180.0,180.0',
