...
describe('Strategy campaign V3', () => {
  ...
  it('keeps the most severe condition and remembers betrayal', () => {
    ...
    campaign = completeCampaignScenario(campaign, {
      scenarioId: 'succession-guards-359', selectedFactionId: 'prince-camilla', won: false, turnsPlayed: 8, victoryPoints: 1,
    ...
    expect(() => completeCampaignScenario(campaign, {
      scenarioId: 'succession-lockdown-400', selectedFactionId: 'prince-camilla', won: true, turnsPlayed: 1, victoryPoints: 3,
      relationships: {}, unitConditions: {},
