...
export const en = {
  ...
  tourSources: {
    ...
    seoDescription:
      'The evidence behind the reconstructed Black Whale, room by room: which chapter or plan each of the 277 spaces rests on, which corridors the reconstruction invented, and which walls were sealed on purpose.',
    breadcrumb: 'Sources',
